package moderate.Q16_19_Pond_Sizes;

import java.util.ArrayList;

/**
 * You have an integer matrix representing a plot of land, where the value at that location represents the
 * height above sea leve. A value of zero indicates water. A pond is a region of water connected vertically, horizontally or
 * diagonally. The size of the pond is the total number of connected water cells. Write a method to compute the sizes of all ponds
 * in a matrix.
 *
 * 0 2 1 0
 * 0 1 0 1
