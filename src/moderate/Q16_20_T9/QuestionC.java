...
/**
 * On old cell phones, users types on a numeric keypad and the phone would provide a list of words that matched these
 * numbers. Each digit mapped to a set of 0-4 letters. Implement an algorithm to return of a list of matching words, given
 * a sequence of digits. You are provided a list of valid words (provided in whatever data structure you'd like).
 * The mapping is shown in disagram below
 * 1  	  2     3
 *   	abc   def
 *
 *  4   5      6
