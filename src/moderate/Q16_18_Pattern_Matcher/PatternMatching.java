package moderate.Q16_18_Pattern_Matcher;

/**
 * You are given two strings, pattern and value. The pattern string consist of just the letters a and b, describing
 * a pattern within a string. For example, the string catcatgocatgo matches the pattern aabab where cat is a and go is b.
 * It also matches the pattern like a,ab and b. Write a method to determine if value matches pattern.
 *
 */
