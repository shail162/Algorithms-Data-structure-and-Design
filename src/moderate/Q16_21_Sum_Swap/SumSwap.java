package moderate.Q16_21_Sum_Swap;

import java.util.Arrays;
import java.util.HashSet;

/**
 * Given 2 arrays of integers, find a pair of values (one value from each array) that you can swap to given the
 * two arrays the same sum.
 *
 * Example
 * Input : {4,1,2,1,1,2} and {3,6,3,3} --> 11,15
 * Output : {1,3}
 *
 */
