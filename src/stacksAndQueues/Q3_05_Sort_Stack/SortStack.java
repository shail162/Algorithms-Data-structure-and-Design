...
/**
 * Sort stack such that the smallest items are on the top. You can use an additional temporary stack,
 * but you not copy the elements into any other data structure. The stack supports the following
