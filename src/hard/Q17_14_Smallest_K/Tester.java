package hard.Q17_14_Smallest_K;
...
public class Tester {
	...
	public static boolean testArray(int[] array1) {
		...
		for (int i = 0; i < array1.length; i++) {
			array2[i] = SmallestKUsingSelectionRank.rank(array1, i);
		}
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < numberOfTests; i++) {
			...
			int[] smallestB = SmallestKUsingHeap.smallestK(array.clone(), rank);
			int[] smallestD = SmallestKUsingSelectionRank.smallestK(array.clone(), rank);
