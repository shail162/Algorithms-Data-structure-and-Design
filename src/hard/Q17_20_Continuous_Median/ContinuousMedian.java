...
/**
 * Numbers are randomly generated and passed to a method. write a program ti fubd and maintain the median value
...
public class ContinuousMedian {
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < arr.length; i++) {
			int randomNumber = arr[i];//(int) (Math.random( ) * (range+1));
